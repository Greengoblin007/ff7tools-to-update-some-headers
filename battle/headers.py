...
compressed_file_00_size = os.path.getsize("CO_1_0.GZ")
...
uncompressed_file_00_size = os.path.getsize("CO_1_0.data")
...
compressed_file_10_size = os.path.getsize("CO_0_0.GZ")
...
uncompressed_file_10_size = os.path.getsize("CO_0_0.data")
